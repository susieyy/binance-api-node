...
var depth = function depth(payload, cb) {
  var cache = (Array.isArray(payload) ? payload : [payload]).map(function (symbol) {
    return createSocket(symbol.toLowerCase() + '@depth', function (msg) {
  ...
  return function () {
    return cache.forEach(function (close) {
      return close();
    });
  };
};
...
var partialDepth = function partialDepth(payload, cb) {
  var cache = (Array.isArray(payload) ? payload : [payload]).map(function (_ref) {
    ...
    return createSocket(symbol.toLowerCase() + '@depth' + level, function (msg) {
...
var candles = function candles(payload, interval, cb) {
  ...
  var cache = (Array.isArray(payload) ? payload : [payload]).map(function (symbol) {
    return createSocket(symbol.toLowerCase() + '@kline_' + interval, function (msg) {
...
var ticker = function ticker(payload, cb) {
  var cache = (Array.isArray(payload) ? payload : [payload]).map(function (symbol) {
    return createSocket(symbol.toLowerCase() + '@ticker', function (msg) {
...
var allTickers = function allTickers(cb) {
  return createSocket('!ticker@arr', function (msg) {
...
var trades = function trades(payload, cb) {
  var cache = (Array.isArray(payload) ? payload : [payload]).map(function (symbol) {
    return createSocket(symbol.toLowerCase() + '@aggTrade', function (msg) {
